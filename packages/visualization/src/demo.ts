...
const sampleState: TerraformState = {
  resources: [
    ...
    },
    {
      ...
      type: 'security_group',
      name: 'web',
      attributes: { vpc_id: 'aws_vpc.main' },
      state: 'applied',
      parentId: 'aws_vpc.main',
    },
    {
      id: 'aws_instance.web-1',
      type: 'instance',
      name: 'web-1',
      attributes: { 
      ...
      state: 'applied',
      parentId: 'aws_subnet.public',
    },
    {
      id: 'aws_instance.web-2',
      type: 'instance',
      name: 'web-2',
      attributes: { 
        instance_type: 't3.micro',
      ...
      state: 'planned', // Show a planned instance
      parentId: 'aws_subnet.public',
    },
    {
    ...
    },
    {
      ...
      name: 'handler',
      attributes: { runtime: 'nodejs18.x', handler: 'index.handler' },
      state: 'applied',
    },
  ],
  connections: [
...
if (container) {
  const viz = new Visualization(container, defaultTheme);
